...
public class paired_devices extends AppCompatActivity {
    ...
    public void callClient(){
       LinearLayout linear_layout = (LinearLayout) findViewById(R.id.paired_list);
...
//            list.setText(arrayAdapter.getItem(0));
    ...
    public void callServer(){
        ...
        LinearLayout l_l = (LinearLayout) findViewById(R.id.paired_list);
        l_l.setVisibility(View.VISIBLE);
    }
